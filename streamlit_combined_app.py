...
def process_message(message, model="deepseek-r1-distill-llama-70b", temperature=0.7):
    ...
    if lang == 'ar':
        ...
        يجب أن تستمد جميع الإجابات فقط من محتوى السيرة الذاتية المرفقة. إذا سُئلت عن معلومات غير موجودة في السيرة الذاتية، فقل بأدب إنك لا تملك هذه المعلومات.
        ...
        All answers must be drawn only from the content of the uploaded CV. If asked about information not in the CV, politely state that you don't have that information.
